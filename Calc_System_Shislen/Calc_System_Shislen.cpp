...
int main()
{
	...
	do
	{
		...
		if (otvet == 2)
		{
			...
			//		{
			//			_16 = array[i];
			//			if (_16 == char(65)) cout << 10;
			//			else if (_16 == char(66)) cout << 11;
			//			else if (_16 == char(67)) cout << 12;
			//			else if (_16 == char(68)) cout << 13;
			//			else if (_16 == char(69)) cout << 14;
			//			else if (_16 == char(70)) cout << 15;
			//			else cout << _16;
			//		}
